...
function DecisionNodeView({
  ...
  const showName = data.name.trim().length > 0 || data.editing === true;
  ...
  return (
    <div
      ...
      style={{ width, height }}
    >
      <div className={styles.diamond} data-testid="decision-diamond">
        <svg
        ...
        {showName ? (
          <div className={styles.name} data-testid="decision-name">
            <InlineNameEditor
              id={id}
              name={data.name}
...
export const DecisionNode = memo(DecisionNodeView);
