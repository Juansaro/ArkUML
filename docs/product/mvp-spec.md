...
uso. El ciclo **Release 1** es línea **2.0** (biblioteca + secuencia;
TASK-046–050). El ciclo **Release 2** es línea **3.0** (seis kinds;
TASK-052–063). No se implementan desde este archivo.
