...
| ID catálogo | TASK | FR |
| --- | --- | --- |
| W14-03 | [`14-persistence/TASK-038.md`](14-persistence/TASK-038.md) | FR-P03 |
...
| W13-03 | Minimap | P1 | `post-mvp-spec.md` FR-P04; `TASK-009.md` | Navegación en diagramas grandes | Cerrada: chrome; exclusión de export; MiniMap de xyflow; visible ≥1024 px | — | TASK-039 | Congelada |
...
| W15-03 | Clipboard de imagen | P1 | `post-mvp-spec.md` FR-P05 | Pegar en otras apps | Permisos; Safari. Exporter hermano de FR-12 | ADR-006 no hace falta si reutiliza `exportDiagram` | TASK-040 | Congelada |
...
| W17-05 | Hosting estático (runbook) | P1 | `post-mvp-spec.md` FR-P06; `TASK-020.md` | Distribución | Sin secrets cloud | — | TASK-041 | Congelada |
